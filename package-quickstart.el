...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/with-editor-20241201.1419/with-editor-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/which-key-20240620.2145/which-key-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/web-mode-20241227.530/web-mode-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/prescient-20240803.2320/prescient-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/vertico-20250419.816/vertico-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/vertico-prescient-20240803.2320/vertico-prescient-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/treesit-auto-20240511.1425/treesit-auto-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/transient-20250429.904/transient-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/nginx-mode-20240412.402/nginx-mode-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/move-text-20231204.1514/move-text-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/marginalia-20250317.1632/marginalia-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/llama-20250314.2009/llama-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/magit-section-20250428.1147/magit-section-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/magit-20250428.1656/magit-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/leuven-theme-20250422.932/leuven-theme-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/jinx-20250429.727/jinx-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/expand-region-20241217.1840/expand-region-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/emmet-mode-20240617.45/emmet-mode-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/ef-themes-1.9.0/ef-themes-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/crux-20250421.936/crux-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/corfu-20250422.745/corfu-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/corfu-prescient-20240803.2320/corfu-prescient-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/consult-20250419.815/consult-autoloads.el")(load-true-file-name load-file-name))
...
(let* ((load-file-name "/home/drocha/.emacs.d/elpa/apheleia-20250428.21/apheleia-autoloads.el")(load-true-file-name load-file-name))
...
(setq package-activated-list
      (delete-dups
       (append
        '(with-editor which-key web-mode prescient vertico
           vertico-prescient treesit-auto transient nginx-mode
           move-text marginalia llama magit-section magit leuven-theme
           jinx expand-region emmet-mode ef-themes crux corfu
           corfu-prescient consult apheleia)
        package-activated-list)))
(progn
  (require 'info) (info-initialize)
  (setq Info-directory-list
        (append
         '("/home/drocha/.emacs.d/elpa/ef-themes-1.9.0"
           "/home/drocha/.emacs.d/elpa/magit-20250428.1656"
           "/home/drocha/.emacs.d/elpa/magit-section-20250428.1147"
           "/home/drocha/.emacs.d/elpa/transient-20250429.904"
           "/home/drocha/.emacs.d/elpa/with-editor-20241201.1419")
         Info-directory-list)))

;; Local Variables:
